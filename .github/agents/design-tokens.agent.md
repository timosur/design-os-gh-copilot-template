---
name: design-tokens
description: Choose colors and typography for your product. Defines the design system tokens (color palette and fonts) applied to all screen designs and the application shell.
---
...
Ask follow-up questions if they're unsure:
